...
$page1=($page*3)-3;
			...
			$take="SELECT * FROM blogs WHERE photo!='293.png' ORDER BY id1 DESC limit $page1,3 ";
...
<ul class="pagination ">
<?php
$query1="SELECT * FROM blogs WHERE photo!='293.png'";
...
for($b=1;$b<=$a;$b++)
{
  if($page==$b)
   ...
   include'paging_inactive.php';
	...
	<div class="col-md-4 col-md-offset-4" style="margin-top:40px;border:1px dotted black; margin-bottom:10px; padding:20px; box-shadow:3px 3px 3px #cccccc; border-radius:5px;">
	<a></a>
	<?php
	delete();
	function delete()
